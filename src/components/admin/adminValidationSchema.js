...
const schema = Joi.object().keys({
  name: Joi.string().required().max(10).messages({
    ...
    "string.min": ` Pole nie może być krótsze niż {#limit} znaków.`,
    "string.max": ` Pole nie może być dłuższe niż {#limit} znaków.`,
    "any.required": `Pole jest wymagane`,
  }),
  email: Joi.string().required().max(50).messages({
    "string.base": `Pole musi być tekstem`,
    "string.empty": `Pole nie może być puste`,
    "string.max": ` Pole nie może być dłuższe nic {#limit} znaków.`,
    "any.required": `Pole jest wymagane`,
  }),
  ...
  passwordConfirm: Joi.any().valid(Joi.ref("password")).required().messages({
    "any.only": "Hasła muszą pasować",
  }),
  role: Joi.string().required().min(3).max(10).messages({
    "string.base": `Pole musi być tekstem`,
    "string.empty": `Pole nie może być puste`,
    "string.max": ` Pole nie może być dłuższe nic {#limit} znaków.`,
    "any.required": `Pole jest wymagane`,
